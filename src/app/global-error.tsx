...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    if (
      ...
      console.warn('Chunk load error detected in Global Error Boundary. Reloading page...');
    ...
    <html>
      <body className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 text-center font-sans">
        ...
        <p className="text-gray-600 mb-6 max-w-md">
          A loading error occurred. Please try refreshing or click the button below.
        </p>
